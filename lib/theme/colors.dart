...
class AppColors {
  ...
  static final veryLightGrey = Color(0xfff0f0f0);
  static final lightGrey = Color(0xffe0e0e0);
  static final medGrey = Color(0xffc0c0c0);
  static final grey = Color(0xff808080);
  static final darkGrey = Color(0xff404040);
